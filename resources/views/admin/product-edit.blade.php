                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item" id="imgpreview">
                            <img src="{{asset('uploads/products/thumbnails')}}/{{$product->image}}" class="effect8"
                                alt="{{$product->name}}">
                        </div>
                        @endif
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="status">
                                <option value="instock" {{$product->status == "0" ? "instock" : ""}}>InStock</option>
                                <option value="outofstock" {{$product->status == "0" ? "outofstock" : ""}}>Out of Stock</option>
                            </select>
                        </div>
                    </fieldset>
                    @error('status')
